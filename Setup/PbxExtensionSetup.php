...
namespace Modules\ModuleFinnishLanguagePack\Setup;
 ...
 * PbxExtensionSetup
 *
 * Setup class for Finnish Language Pack Module
 *
 * This Language Pack module provides automatic installation of:
 * - Finnish UI translations from Messages/fi/ directory
 * - Finnish voice prompts from Sounds/fi-fi/ directory
 *
 ...
 *
 * @package Modules\ModuleFinnishLanguagePack\Setup
 */
class PbxExtensionSetup extends PbxExtensionSetupBase
{
     ...
     */
    protected string $moduleUniqueID = 'ModuleFinnishLanguagePack';

    /**
     * Additional actions before module installation
     *
     * For Language Pack modules, we check for conflicts with other Finnish packs.
    ...
    public function onBeforeModuleEnable(): bool
    {
        ...
        if ($conflictModule !== null) {
            $this->messages[] = "Cannot install: Another Finnish Language Pack ($conflictModule) is already installed. Please uninstall it first.";
            return false;
        }
    ...
    public function onAfterModuleEnable(): bool
    {
        SystemMessages::sysLogMsg(
            __CLASS__,
            'Finnish Language Pack installed successfully',
            LOG_INFO
        );
    ...
    public function onBeforeModuleDisable(): bool
    {
        SystemMessages::sysLogMsg(
            __CLASS__,
            'Uninstalling Finnish Language Pack',
            LOG_INFO
        );
    ...
    public function onAfterModuleDisable(): bool
    {
        SystemMessages::sysLogMsg(
            __CLASS__,
            'Finnish Language Pack uninstalled successfully',
            LOG_INFO
        );
